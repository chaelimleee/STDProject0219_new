	...
	CREATE OR REPLACE procedure random_users_generator
	IS
	...
	BEGIN
	    ...
	    FOR i IN 1..100 LOOP
	        ...
	        ('ezen' || (1000+i),
	         '김' || (100+i),
	         '123456879',         
	         round(DBMS_RANDOM.VALUE(1,90),0),
	         'ezen' || i || '@abcd.com');
	...
	CREATE OR REPLACE procedure random_name_generator
	IS
	...
	BEGIN  
		...
		FOR i IN 1..100 LOOP  
	        ...
	        UPDATE users SET username = total_name  
	        WHERE userid = 'ezen' || (1000+i);       

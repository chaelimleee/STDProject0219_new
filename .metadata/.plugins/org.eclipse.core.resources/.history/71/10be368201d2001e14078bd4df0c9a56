...
import com.javateam.foodCrawlingDemo.repository.FoodService;
...
public class FoodCrawlTest {
	...
	public void test() throws Exception {
		...
		try {
			...
			// 이미지 저장(다운로드)
			String path = "C:/ALEELIM/works/spring_food1/foodCrawlingDemo/upload_image2/";
			...
			log.info(" 투스트링 66^ ==> " + foodVO.toString());
			foodService.saveCrawData(foodVO);
